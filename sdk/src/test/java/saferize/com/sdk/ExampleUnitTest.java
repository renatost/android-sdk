...
public class ExampleUnitTest {
    ...
    public void testSignUp() throws SaferizeClientException, AuthenticationException, URISyntaxException {
        Configuration configuration = new Configuration(new URI("http://api.dev.saferize"), new URI("ws://websocket.dev.saferize/usage"), "6b405c76-4b36-4821-9ab5-3a4a127b2af1", privateKey);
        SaferizeClient client = new SaferizeClient(configuration);
        client.createSession("MyToken");
    }
